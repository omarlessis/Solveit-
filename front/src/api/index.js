...
export const validateAnswer = (answer_id) => API.patch("/answer/validate/" + answer_id);
...
//get Notifications
export const getNotification = () => API.get('/notification/getNotifs');

//Update User
export const updateUserAPI = ({name, password, newPassword, confirmPassword, id, image}) => API.patch("/user/"+ id, {name, password, newPassword, confirmPassword, image});