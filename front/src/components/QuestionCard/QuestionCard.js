        ...
        <form className="flex flex-col p-4">
          ...
          <div className="mx-2">
            <input
              ...
              className="placeholder-gray-400 w-full h-8 border mt-1  border-gray-300 p-3 text-sm rounded focus:border-purple-800 outline-none"
            />
          </div>
          <label className="text-left ml-2 mt-3 font-medium ">Body</label>
          <label className="text-left text-xs ml-2">
            Include all the information someone could answer your
            question
          </label>
          <div className="mx-2">
            <textarea
              ...
              type="text"
              className="placeholder-gray-400  w-full h-64 border text-sm mt-1 border-gray-300 p-3 rounded focus:border-purple-800 outline-none"
            />
          </div>
          ...
          <div className="flex items-center justify-center">
            <button
              className=" flex items-center p-2 m-1 mt-3 bg-purple-800 border-2 border-gray-200 rounded text-white hover:bg-purple-500 h-10"
              type="submit"
