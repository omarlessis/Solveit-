    ...
    <div className="w-72 fixed z-0 border-gray-300 border-r h-screen text-right pl-32 pt-20 ">
      <div className="my-2">
        <NavLink
          ...
          activeClassName="border-r-4 text-gray-800 bg-gray-100 font-bold"
        >
          Home
        </NavLink>
      ...
      <div className="w-40 border-gray-300 text-right">
        <div>
          <NavLink
            ...
            activeClassName="text-gray-800 border-r-4 bg-gray-100 font-bold"
          >
        ...
        <div>
          ...
          <div className="flex items-center justify-center">
              <User />
              <span className="inline-block ml-1">User</span>
            </div>
          </NavLink>
        </div>
      </div>
