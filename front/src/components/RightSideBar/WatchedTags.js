      ...
      {watchClick ? (
        <div className=" flex flex-col p-2 items-center text-center justify-evenly rounded ">
            ...
            {selectedTags.map((tag, index) => (
              <>
                {tag !== "" && (
                  <div
                    key={index}
                    className="m-1 text-xs px-0.5 py-0.5 bg-purple-800 border-2 border-gray-200 hover:bg-purple-500 text-white my-1.5  rounded "
                  >
          ...
          <input
            ...
            className="placeholder-gray-500 w-full h-10 border-2 border-gray-200 text-sm p-3 rounded focus:border-purple-800 outline-none"
          />
          <button
            className="flex items-center p-2 m-1 bg-purple-800 border-2 border-gray-200 rounded text-white hover:bg-purple-500 h-10"
        ...
        <div className="flex flex-col items-center mt-5 ">
          ...
          <button
            className=" my-3 flex justify-center items-center p-2 w-32 m-1 bg-purple-800 border-2 border-gray-300 rounded text-white hover:bg-purple-500"
